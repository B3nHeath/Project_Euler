## We have a 20x20 grid, need to decide how to store this. Then I need to find the greatest product of four number in any one direction:
## Left, right, up, down, diagonally

row_1 =  [8, 2, 22, 97, 38, 15, 00, 40, 00, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8]
row_2 =  [49, 49, 99, 40, 17, 81, 18, 57, 60, 87, 17, 40, 98, 43, 69, 48, 4, 56, 62, 00]
...
row_10 = [21, 36, 23, 9, 75, 00, 76, 44, 20, 45, 35, 14, 00, 61, 33, 97, 34, 31, 33, 95]
row_11 = [78, 17, 53, 28, 22, 75, 31, 67, 15, 94, 3, 80, 4, 62, 16, 14, 9, 53, 56, 92]
row_12 = [16, 39, 5, 42, 96, 35, 31, 47, 55, 58, 88, 24, 00, 17, 54, 24, 36, 29, 85, 57]
row_13 = [86, 56, 00, 48, 35, 71, 89, 7, 5, 44, 44, 37, 44, 60, 21, 58, 51, 54, 17, 58]
...
row_10, row_11, row_12, row_13, row_14, row_15, row_16, row_17, row_18, row_19, row_20]
...
for x in range(0,17):
    for y in range(0,20):
        product = rows[x][y] * rows[x+1][y] * rows[(x+2)][y] * rows[(x+3)][y]
        if product > LProd:
            LProd = product
